...
import com.practical.PROJECT.dto.DepositRequestDto;
...
public class AccountController {
    ...
    public ResponseEntity<Double> deposit(@PathVariable String customerId, @RequestBody DepositRequestDto depositRequest) {
        try {
            Double newBalance = accountService.deposit(customerId, Double.parseDouble(depositRequest.getAmount()));
