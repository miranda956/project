...
//    public String getPinByAccountNumber(String accountNumber) {
//        Customer customer = customerRepository.findByAccountNumber(accountNumber).getCustomer();
//        if (customer != null) {
//            return customer.getPin();
//        } else {
//            throw new NoSuchElementException("Customer not found for account number: " + accountNumber);
//        }
//    }

    public String getPinByCustomerId(String customerId) {
        Customer customer = customerRepository.findByCustomerId(customerId);
        if (customer != null) {
            return customer.getPin();
        } else {
            throw new NoSuchElementException("Customer not found for customer ID: " + customerId);
        }
    }
